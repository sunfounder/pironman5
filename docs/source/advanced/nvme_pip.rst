...
* **FORCE ENABLE**: オンボードの電源はPCIeインターフェイスのスイッチ信号によって起動されます。Raspberry Piが起動すると、3.3V電源をオンにする信号が送られます。一部のシステムがスイッチ信号をサポートしていない場合や他の理由がある場合は、J4 FORCE ENABLEの2つの浮遊パッドを短絡させるために、ワイヤをはんだ付けしてオンボードの3.3V電源を強制的にNVMeに供給できます。
...
Pironman 5 は、名前に基づいて4つの（PCIe Gen 2.0 / PCIe Gen 3.0）NVMe M.2 SSDサイズ2230、2242、2260、2280をサポートします。「22」は幅をミリメートル（mm）で表し、その後の2桁の数字は長さを示します。ドライブが長いほど、より多くのNANDフラッシュチップを搭載できるため、容量が増えます。
