...
If you have an NVMe SSD but lack an adapter to connect it to your computer, you can opt for a third approach: initially install the system on your Micro SD card. After the Pironman 5 Pro MAX successfully boots up, you can then transfer the system from your Micro SD card to your NVMe SSD.

* First, you need to :ref:`install_os_sd_rpi_promax`.
...
#. Go to the **OS** section and choose the recommended **Raspberry Pi OS (64-bit)** option.
   ...
   .. warning::
      ...
      Be sure to choose a **64-bit** version. If you install a **32-bit** system, some packages are only available for ``aarch64`` (64-bit), and certain features may fail to install or work properly.
