...
该液晶屏可以直接安装在树莓派的GPIO接口上，为Pironman 5 Mini增加图像显示和触摸操作功能。请按照正确步骤进行组装，以避免设备损坏。
...
.. warning:: 将3.5英寸液晶屏安装到Pironman 5 Mini时，请务必确认接口方向完全对应。液晶模块的连接端必须与树莓派的GPIO接口完全对应。如果连接错位，可能会导致液晶屏或主机损坏。在通电前，请仔细检查连接情况。
