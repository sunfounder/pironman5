...
3.  现在你可以在 ``openclaw tui`` 中操作 Pironman5 Mini 了。尝试在 TUI 中发送命令，例如尝试打开机箱上的 LED 灯、改变它们的颜色，或者让摄像头拍照。你甚至可以告诉它你有一个连接到 GPIO17 的 DHT11 模块，让它告诉你温度。
