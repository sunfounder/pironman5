...
7. Cliquez sur **NEXT**, puis sélectionnez **NO**. Umbrel OS initialisera automatiquement son propre système et la configuration de l’utilisateur lors du premier démarrage, et n’utilise pas le nom d’utilisateur ni le mot de passe définis dans le Raspberry Pi Imager.
