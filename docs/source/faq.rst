...
NVMe SSD を持っているが、NVMe をコンピュータに接続するためのアダプターがない場合は、最初に Micro SD カードにシステムをインストールできます。|link_pironman5| が正常に起動したら、Micro SD カードから NVMe SSD にシステムをコピーできます。詳細な手順は以下の通りです：
