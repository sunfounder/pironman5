...
If you have installed Umbrel OS on your Raspberry Pi 5, you will need to configure the Pironman 5 using the command line. Detailed instructions are provided below:
