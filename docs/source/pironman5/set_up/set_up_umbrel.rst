...
如果你在 Raspberry Pi 5 上安装了 Umbrel OS，可以通过命令行来配置 Pironman 5。按照以下步骤完成设置：
...
#. 通过设置用户名和密码来创建你的 Umbrel 账户。该密码将用于今后的远程访问，请妥善保管。

   .. image:: img/umbrel_account.png

#. 点击 **Next** 完成 Umbrel 设置并进入桌面环境。
...
#. 在 Umbrel App Store 中，点击右上角的 **Community App Store** 按钮。
