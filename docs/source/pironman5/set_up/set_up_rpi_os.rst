...
Si vous avez installé Raspberry Pi OS, Ubuntu, Kali Linux ou Homebridge sur votre Raspberry Pi, vous devrez configurer le Pironman 5 en ligne de commande.
...
#. Une fois le Pironman 5 démarré avec succès, vérifiez que les composants suivants fonctionnent correctement.
   ...
   * **Bouton d'alimentation**
     ...
     * Maintenir 2 secondes : Arrêt sécurisé (nécessite :ref:`safe_shutdown_5`).
...
.. note::
   ...
   Pour les contrôles avancés et les fonctionnalités du tableau de bord, consultez :ref:`control_commands_dashboard_5`.
