...
1. 下载最新的 Umbrel OS 映像并解压。你也可以访问 `Umbrel 发布页面 <https://github.com/getumbrel/umbrel/releases>`_ 来选择特定版本。

   * :download:`最新的 Umbrel OS 映像 <https://download.umbrel.com/release/latest/umbrelos-pi5.img.zip>`
...
5. 选择你之前下载的 Umbrel OS 映像文件，然后点击 **Open**。
...
8. 如果 NVMe SSD 中已有数据，请在继续之前备份以防数据丢失。如果不需要备份，点击 **Yes** 继续。

   .. image:: img/nvme_erase.png
      :width: 90%

9. 当出现 “Write Successful” 提示时，表示映像已成功写入并验证完成。你的 NVMe SSD 现在已经准备好用于启动 Raspberry Pi！
