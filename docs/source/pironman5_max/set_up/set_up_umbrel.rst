...
Se hai installato Umbrel OS sul tuo Raspberry Pi 5, dovrai configurare il Pironman 5 MAX utilizzando la riga di comando. Di seguito sono fornite le istruzioni dettagliate:
...
#. Al riavvio, il servizio ``pironman5.service`` verrà avviato automaticamente.  
   ...
   * Le ventole RGB sono impostate di default sulla modalità **Always On**. Per temperature di attivazione diverse, consulta :ref:`cc_control_fan_max`.
