...
.. warning::
   ...
   La procédure décrite ici est cohérente avec :ref:`install_os_sd_rpi_max`, mais lors du choix de l’image, veuillez sélectionner Raspberry Pi OS Lite dans la section Raspberry Pi OS (autre).
