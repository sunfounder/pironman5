...
.. warning::
   ...
   Die Vorgehensweise entspricht der Anleitung unter :ref:`install_os_sd_rpi_max`, jedoch wählen Sie beim Auswählen des Images bitte „Raspberry Pi OS Lite“ aus der Kategorie „Raspberry Pi OS (other)“.
